...
const Navbar = () => {
  ...
  return (
    <NavbarBS sticky="top" className="bg-secondary h5 shadow p-3 ">
      <Container>
        <Nav className="navbar-dark me-auto ">
        ...
        <Button
          ...
          <svg
            ...
            <g>
              <g>
                <path
                  d="M469.336,401.072c-8.107,0-15.616,2.398-22.084,6.34l-79.343-85.444l74.172-263.68l63.462-15.863
